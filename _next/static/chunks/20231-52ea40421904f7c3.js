    ...
    72972: function (e, t, n) {
      ...
      let _ = i.default.forwardRef(function (e, t) {
        ...
        let q = N ? r && "object" == typeof r && r.ref : t,
          [B, F, $] = (0, p.useIntersection)({ rootMargin: "200px" }),
          Y = i.default.useCallback(
            (e) => {
              (K.current !== z || D.current !== W) &&
                ($(), (K.current = z), (D.current = W)),
                B(e),
                q &&
                  ("function" == typeof q
        ...
        i.default.useEffect(() => {
          k && F && T && b(k, W, z, { locale: w }, { kind: U }, A);
        }, [z, W, F, w, T, null == I ? void 0 : I.locale, k, A, U]);
        let H = {
          ref: Y,
          onClick(e) {
        ...
        if ((0, s.isAbsoluteUrl)(z)) H.href = z;
        else if (!N || R || ("a" === r.type && !("href" in r.props))) {
          let e = void 0 !== w ? w : null == I ? void 0 : I.locale,
            t =
          ...
          H.href =
            t ||
            (0, m.addBasePath)(
              (0, c.addLocale)(z, e, null == I ? void 0 : I.defaultLocale)
            );
        }
        return N
          ? i.default.cloneElement(r, H)
          : (0, o.jsx)("a", { ...C, ...H, children: n });
      });
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
